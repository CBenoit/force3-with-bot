...
\begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{Heuristic_Normal}{}
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{Heuristic_Hard}{}
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{Heuristic_Legendary}{}
